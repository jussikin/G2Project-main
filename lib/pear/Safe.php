 ...
 * @version    CVS: $Id: Safe.php 20957 2009-12-16 04:57:07Z mindless $
...
class HTML_Safe
{
     ...
     * @access public
     */
    public $deleteTags = array('applet', 'base', 'basefont', 'bgsound', 'blink', 'body', 'embed', 'frame', 'frameset', 'head', 'html', 'ilayer', 'iframe', 'layer', 'link', 'meta', 'object', 'style', 'title', 'script');
     ...
     * @access public
     */
    public $blackProtocols = array('about', 'chrome', 'data', 'disk', 'hcp', 'help', 'javascript', 'livescript', 'lynxcgi', 'lynxexec', 'ms-help', 'ms-its', 'mhtml', 'mocha', 'opera', 'res', 'resource', 'shell', 'vbscript', 'view-source', 'vnd.ms.radio', 'wysiwyg');
     ...
     * @access public
     */
    public $whiteProtocols = array('ed2k', 'file', 'ftp', 'gopher', 'http', 'https', 'irc', 'mailto', 'news', 'nntp', 'telnet', 'webcal', 'xmpp', 'callto');
     ...
     * @access public
     */
    public $protocolAttributes = array('action', 'background', 'codebase', 'dynsrc', 'href', 'lowsrc', 'src');
     ...
     * @access public
     */
    public $cssKeywords = array('absolute', 'behavior', 'behaviour', 'content', 'expression', 'fixed', 'include-source', 'moz-binding');
     ...
     * @access public
     */
    public $closeParagraph = array('address', 'blockquote', 'center', 'dd', 'dir', 'div', 'dl', 'dt', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'hr', 'isindex', 'listing', 'marquee', 'menu', 'multicol', 'ol', 'p', 'plaintext', 'pre', 'table', 'ul', 'xmp');
     ...
     * @access public
     */
    public $tableTags = array('caption', 'col', 'colgroup', 'tbody', 'td', 'tfoot', 'th', 'thead', 'tr');
    ...
    public function _writeAttrs($attrs)
    {
        if (is_array($attrs)) {
            foreach ($attrs as $name => $value) {
                ...
                $tempval = preg_replace_callback('/&#(\d+);?/m', function ($m) {
                    return chr($m[1]);
                }, $value); //"'
                $tempval = preg_replace_callback('/&#x([0-9a-f]+);?/mi', function ($m) {
