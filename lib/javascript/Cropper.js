...
CropFrame.prototype.maximize = function (e, frame) {
    ...
    frame.reshapeTo(
        orig_dims.top,
        orig_dims.left + new_dims.width,
        orig_dims.top + new_dims.height,
        orig_dims.left
    );
...
Cropper.prototype.resetFrame = function () {
    this.setFrameDimensions(
        this.origDimensions[0],
        this.origDimensions[1],
        this.origDimensions[2],
        this.origDimensions[3]
    );
}
