...
class XML_HTMLSax3_StateParser
{
    ...
    {
        $this->XML_HTMLSax3_StateParser($htmlsax);
    }
    ...
    public function parse($data)
    {
        if ($this->parser_options['XML_OPTION_TRIM_DATA_NODES'] == 1) {
            $decorator = new XML_HTMLSax3_Trim($this->handler_object_data, $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'trimData';
        }
        if ($this->parser_options['XML_OPTION_CASE_FOLDING'] == 1) {
            $open_decor = new XML_HTMLSax3_CaseFolding($this->handler_object_element, $this->handler_method_opening, $this->handler_method_closing);
        ...
        if ($this->parser_options['XML_OPTION_LINEFEED_BREAK'] == 1) {
            $decorator = new XML_HTMLSax3_Linefeed($this->handler_object_data, $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'breakData';
        }
        if ($this->parser_options['XML_OPTION_TAB_BREAK'] == 1) {
            $decorator = new XML_HTMLSax3_Tab($this->handler_object_data, $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'breakData';
        }
        if ($this->parser_options['XML_OPTION_ENTITIES_UNPARSED'] == 1) {
            $decorator = new XML_HTMLSax3_Entities_Unparsed($this->handler_object_data, $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'breakData';
        }
        if ($this->parser_options['XML_OPTION_ENTITIES_PARSED'] == 1) {
            $decorator = new XML_HTMLSax3_Entities_Parsed($this->handler_object_data, $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'breakData';
        }
        // Note switched on by default
        if ($this->parser_options['XML_OPTION_STRIP_ESCAPES'] == 1) {
            $decorator = new XML_HTMLSax3_Escape_Stripper($this->handler_object_escape, $this->handler_method_escape);
...
class XML_HTMLSax3_StateParser_Lt430 extends XML_HTMLSax3_StateParser
{
    ...
    public function __construct(&$htmlsax)
    {
        $this->XML_HTMLSax3_StateParser_Lt430($htmlsax);
    }
    
    public function XML_HTMLSax3_StateParser_Lt430(&$htmlsax)
    {
...
class XML_HTMLSax3_StateParser_Gtet430 extends XML_HTMLSax3_StateParser
{
    ...
    public function __construct(&$htmlsax)
    {
        $this->XML_HTMLSax3_StateParser_Gtet430($htmlsax);
    }
    
    public function XML_HTMLSax3_StateParser_Gtet430(&$htmlsax)
    {
        parent::XML_HTMLSax3_StateParser($htmlsax);
        $this->parser_options['XML_OPTION_TRIM_DATA_NODES'] = 0;
        $this->parser_options['XML_OPTION_CASE_FOLDING'] = 0;
...
class XML_HTMLSax3_Trim
{
    ...
    {
        $this->XML_HTMLSax3_Trim($orig_obj, $orig_method);
    }
...
class XML_HTMLSax3_CaseFolding
{
    ...
    {
        $this->XML_HTMLSax3_CaseFolding($orig_obj, $orig_open_method, $orig_close_method);
    }
    
    public function XML_HTMLSax3_CaseFolding(&$orig_obj, $orig_open_method, $orig_close_method)
    {
        $this->orig_obj =& $orig_obj;
...
class XML_HTMLSax3_Linefeed
{
    ...
    public function __construct(&$orig_obj, $orig_method)
    {
        $this->XML_HTMLSax3_LineFeed($orig_obj, $orig_method);
    }
...
class XML_HTMLSax3_Tab
{
    ...
    public function __construct(&$orig_obj, $orig_method)
    {
        $this->XML_HTMLSax3_Tab($orig_obj, $orig_method);
    }
    
    public function XML_HTMLSax3_Tab(&$orig_obj, $orig_method)
    {
        $this->orig_obj =& $orig_obj;
        $this->orig_method = $orig_method;
    }
...
class XML_HTMLSax3_Entities_Parsed
{
    ...
    public function __construct(&$orig_obj, $orig_method)
    {
        $this->XML_HTMLSax3_Entities_Parsed($orig_obj, $orig_method);
    }
    
    public function XML_HTMLSax3_Entities_Parsed(&$orig_obj, $orig_method)
    {
        $this->orig_obj =& $orig_obj;
        $this->orig_method = $orig_method;
    }
...
if (version_compare(phpversion(), '4.3', '<') && !function_exists('html_entity_decode')) {
    ...
    {
        return strtr($str, array_flip(get_html_translation_table(HTML_ENTITIES, $style)));
    }
}
/**
...
class XML_HTMLSax3_Entities_Unparsed
{
    ...
    public function __construct(&$orig_obj, $orig_method)
    {
        $this->XML_HTMLSax3_Entities_Unparsed($orig_obj, $orig_method);
    }
    
    public function XML_HTMLSax3_Entities_Unparsed(&$orig_obj, $orig_method)
    {
        $this->orig_obj =& $orig_obj;
        $this->orig_method = $orig_method;
    }
...
class XML_HTMLSax3_Escape_Stripper
{
    ...
    public function __construct(&$orig_obj, $orig_method)
    {
        $this->XML_HTMLSax3_Escape_Stripper($orig_obj, $orig_method);
    }
    
    public function XML_HTMLSax3_Escape_Stripper(&$orig_obj, $orig_method)
    {
        $this->orig_obj =& $orig_obj;
        $this->orig_method = $orig_method;
    }
