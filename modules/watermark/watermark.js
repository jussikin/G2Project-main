...
function initWatermarkFloater(
	...
	floater_dd.setXConstraint(
		floater_x_offset - 1,
		background_width - floater_x_offset - floater_width,
		1
	);
	floater_dd.setYConstraint(
		floater_y_offset - 1,
		background_height - floater_y_offset - floater_height,
		1
	);
}
